...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: ogImages,
      author: authors.lenght > 0 ? authors : [siteMetadata.author],
    },
    twitter: {
    ...
    <>
      ...
      <article>
        <div className="mb-8 text-center relative w-full h-[70vh] bg-dark">
          {/* ------------------------ TEXT */}
          <div className="w-full z-10 flex flex-col items-center justify-center absolute top-1/2 -translate-y-1/2">
            <Tag
              name={blog.tags[0]}
          ...
          {/* ------------------------ OVERLAY */}
          <div className="absolute top-0 bottom-0 right-0 left-0 h-full bg-dark/60 dark:bg-dark/40" />
